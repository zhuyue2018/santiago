		...
		//|    
		//| 作者：E旺，QQ：407542585，Blog：http://blog.csdn.net/envon123   
		//|    
		//|------------------------------------------------------------------------------------    
		//|
		...
		function EV_Show_bgDiv(){    
		    var bgObj=document.getElementById("EV_bgModeAlertDiv");    
		    var bgWidth=EV_myClientWidth()+12;    
		    var bgHeight=EV_myClientHeight()+12;    
		    var bgTop=EV_myScrollTop();    
		    var bgLeft=EV_myScrollLeft();    
		    ...
		    bgObj.style.filter     = "progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=40,finishOpacity=60);";    
