...
CREATE TABLE `merchant_pay_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '该表用来存放用户开通的第三方支付信息' ROW_FORMAT = Dynamic;
...
INSERT INTO `persistent_logins` VALUES ('admin', 'vO2npdI422JitAfy1yzIsA==', '1qWu/1hmYBihIxqWeuSzPA==', '2019-10-17 11:21:53');
INSERT INTO `persistent_logins` VALUES ('admin', 'W0LGkHU3WzM5bddV06CJmA==', 'VXxgGCe308H01Ui2PTqQxA==', '2019-10-17 08:33:36');
...
CREATE TABLE `pms_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1072 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1127 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限与角色关联表' ROW_FORMAT = Dynamic;
