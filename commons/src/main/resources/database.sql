...
-- ----------------------------
INSERT INTO `merchant_pay_config` VALUES ('3', '2019-10-13 00:36:53', '2019-10-13 00:36:53', '1.0.0', null, '1', null, null, '001', null, '123456', null, null, null);
...
CREATE TABLE `merchant_pay_info` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='该表用来存放用户开通的第三方支付信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='通知记录表 notify_record';
...
CREATE TABLE `pms_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='操作员表';

-- ----------------------------
-- Records of pms_operator
-- ----------------------------
INSERT INTO `pms_operator` VALUES ('1', '2016-06-03 11:07:43', '2016-06-03 11:07:43', '0', 'ACTIVE', 'roncoo', 'admin', '超级管理员', '超级管理员', '18620936193', 'admin', 'd3c59d25033dbf980d29554025c23a75', 'ADMIN', '8d78869f470951332959580424d4bf4f');
INSERT INTO `pms_operator` VALUES ('2', '2016-06-03 11:07:43', '2016-06-03 11:07:43', '0', 'ACTIVE', 'roncoo', 'guest', '游客', '游客', '18926215592', 'guest', '3f0dbf580ee39ec03b632cb33935a363', 'USER', '183d9f2f0f2ce760e98427a5603d1c73');
...
CREATE TABLE `pms_operator_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限_操作员操作日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='操作员与角色关联表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1062 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限与角色关联表';
...
INSERT INTO `pms_role_menu` VALUES ('1031', null, null, null, null, null, null, null, '2', '1');
INSERT INTO `pms_role_menu` VALUES ('1032', null, null, null, null, null, null, null, '2', '2');
INSERT INTO `pms_role_menu` VALUES ('1033', null, null, null, null, null, null, null, '2', '3');
INSERT INTO `pms_role_menu` VALUES ('1034', null, null, null, null, null, null, null, '2', '4');
INSERT INTO `pms_role_menu` VALUES ('1035', null, null, null, null, null, null, null, '2', '5');
...
INSERT INTO `pms_role_menu` VALUES ('1039', null, null, null, null, null, null, null, '2', '20');
INSERT INTO `pms_role_menu` VALUES ('1040', null, null, null, null, null, null, null, '2', '22');
INSERT INTO `pms_role_menu` VALUES ('1041', null, null, null, null, null, null, null, '2', '30');
INSERT INTO `pms_role_menu` VALUES ('1042', null, null, null, null, null, null, null, '2', '32');
INSERT INTO `pms_role_menu` VALUES ('1043', null, null, null, null, null, null, null, '2', '33');
...
INSERT INTO `pms_role_menu` VALUES ('1049', null, null, null, null, null, null, null, '2', '60');
INSERT INTO `pms_role_menu` VALUES ('1050', null, null, null, null, null, null, null, '2', '62');
INSERT INTO `pms_role_menu` VALUES ('1051', null, null, null, null, null, null, null, '2', '63');
INSERT INTO `pms_role_menu` VALUES ('1052', null, null, null, null, null, null, null, '2', '64');
...
INSERT INTO `sys_resource` VALUES ('13', '菜单管理', '2', '/menu', '12', '1');
...
CREATE TABLE `trade_payment_order` (
  ...
  `pay_way_code` char(3) DEFAULT NULL COMMENT '支付方式编号',
  ...
  `pay_type_code` char(3) DEFAULT NULL COMMENT '支付类型编号',
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='roncoo pay 龙果支付 支付订单表';

-- ----------------------------
-- Records of trade_payment_order
-- ----------------------------
INSERT INTO `trade_payment_order` VALUES ('8', '1.0.0', '2019-10-13 05:48:16', null, null, '2019-10-13 09:30:51', '1', 'car', '201910130907', '99.990000', null, 'zhuyue', '001', '2019-10-13 01:09:00', null, '', '', '', '', null, '30', '2019-10-13 01:39:00', '001', null, '', null, null, null, null, null, null, null, null, null, null, null, '', '');
INSERT INTO `trade_payment_order` VALUES ('9', '1.0.0', '2019-10-13 09:39:47', null, null, '2019-10-13 09:39:47', '0', 'car', '201910130908', '99.990000', null, 'zhuyue', '001', '2019-10-13 01:09:00', null, '127.0.0.1', '', 'testreturnurl', 'testnotifyurl', null, '30', '2019-10-13 01:39:00', '001', null, '231', null, null, null, null, null, null, null, null, null, null, null, '', '');
INSERT INTO `trade_payment_order` VALUES ('10', '1.0.0', '2019-10-13 09:40:50', null, null, '2019-10-13 09:40:50', '0', 'car', '201910130909', '99.990000', null, 'zhuyue', '001', '2019-10-13 01:09:00', null, '127.0.0.1', '', 'testreturnurl', 'testnotifyurl', null, '30', '2019-10-13 01:39:00', '001', null, '231', null, null, null, null, null, null, null, null, null, null, null, '', '');
INSERT INTO `trade_payment_order` VALUES ('11', '1.0.0', '2019-10-13 09:45:12', null, null, '2019-10-13 09:45:12', '0', 'car', '201910130910', '99.990000', null, 'zhuyue', '001', '2019-10-13 01:09:00', null, '127.0.0.1', '', 'testreturnurl', 'testnotifyurl', null, '30', '2019-10-13 01:39:00', '001', null, '231', null, null, null, null, null, null, null, null, null, null, null, '', '');
INSERT INTO `trade_payment_order` VALUES ('12', '1.0.0', '2019-10-13 09:51:30', null, null, '2019-10-13 09:51:30', '0', 'car', '201910130911', '99.990000', null, 'zhuyue', '001', '2019-10-13 01:09:00', null, '127.0.0.1', '', 'testreturnurl', 'testnotifyurl', null, '30', '2019-10-13 01:39:00', '001', null, '231', null, null, null, null, null, null, null, null, null, null, null, '', '');
INSERT INTO `trade_payment_order` VALUES ('13', '1.0.0', '2019-10-13 09:52:16', null, null, '2019-10-13 09:52:16', '0', 'car', '201910130912', '99.990000', null, 'zhuyue', '001', '2019-10-13 01:09:00', null, '127.0.0.1', '', 'testreturnurl', 'testnotifyurl', null, '30', '2019-10-13 01:39:00', '001', null, '231', null, null, null, null, null, null, null, null, null, null, null, '', '');
INSERT INTO `trade_payment_order` VALUES ('14', '1.0.0', '2019-10-13 10:24:40', null, null, '2019-10-13 10:24:40', '0', 'car', '201910130913', '99.990000', null, 'zhuyue', '001', '2019-10-13 01:09:00', null, '127.0.0.1', '', 'testreturnurl', 'testnotifyurl', null, '30', '2019-10-13 01:39:00', '001', null, '231', null, null, null, null, null, null, null, null, null, null, null, '', '');
INSERT INTO `trade_payment_order` VALUES ('15', '1.0.0', '2019-10-13 10:25:14', null, null, '2019-10-13 10:25:14', '0', 'car', '201910130914', '99.990000', null, 'zhuyue', '001', '2019-10-13 01:09:00', null, '127.0.0.1', '', 'testreturnurl', 'testnotifyurl', null, '30', '2019-10-13 01:39:00', '001', null, '231', null, null, null, null, null, null, null, null, null, null, null, '', '');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='支付记录表';

-- ----------------------------
-- Records of trade_payment_record
-- ----------------------------
INSERT INTO `trade_payment_record` VALUES ('1', '1.0.0', '2019-10-13 05:48:16', '1', null, null, '2019-10-13 09:30:51', 'car', '201910130907', '77772019101310000001', '66662019101310000001', null, 'zhuyue', '001', null, null, '99.990000', '5.999400', null, null, null, null, null, null, null, null, '99.990000', '93.990600', '0.060000', null, null, null, '/channel/receiveNotify', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `trade_payment_record` VALUES ('5', '1.0.0', '2019-10-13 09:51:30', '0', null, null, '2019-10-13 09:51:30', 'car', '201910130911', '77772019101310000002', '66662019101310000001', null, 'zhuyue', '001', null, null, '99.990000', '5.999400', null, null, null, null, null, null, null, null, '99.990000', '93.990600', '0.060000', null, null, null, '/channel/receiveNotify', null, null, null, null, null, null, null, null, null, null, null, null, '231', null, null, null, null, null, null);
INSERT INTO `trade_payment_record` VALUES ('7', '1.0.0', '2019-10-13 10:24:40', '0', null, null, '2019-10-13 10:24:40', 'car', '201910130913', '77772019101310000003', '66662019101310000001', null, 'zhuyue', '001', null, null, '99.990000', '5.999400', null, null, null, null, null, null, null, null, '99.990000', '93.990600', '0.060000', null, null, null, '/channel/receiveNotify', null, null, null, null, null, null, null, null, null, null, null, null, '231', null, null, null, null, null, null);
INSERT INTO `trade_payment_record` VALUES ('8', '1.0.0', '2019-10-13 10:25:14', '0', null, null, '2019-10-13 10:25:14', 'car', '201910130914', '77772019101310000004', '66662019101310000002', null, 'zhuyue', '001', null, null, '99.990000', '5.999400', null, null, null, null, null, null, null, null, '99.990000', '93.990600', '0.060000', null, null, null, '/channel/receiveNotify', null, null, null, null, null, null, null, null, null, null, null, null, '231', null, null, null, null, null, null);
