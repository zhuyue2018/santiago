...
public class IOUtils {
    ...
    public static byte[] toByteArray(InputStream input, long size) throws IOException {
        if (size > 2147483647L) {
            throw new IllegalArgumentException("Size should not be greater than Integer max value: " + size);
        } else {
    ...
    public static boolean contentEquals(Reader input11, Reader input22) throws IOException {
        Reader input1 = toBufferedReader(input11);
        Reader input2 = toBufferedReader(input22);
