...
public class UnionReq {
    ...
    public static String getContentStr(UnionReq req) throws UnsupportedEncodingException {
        return new String((new Base64()).decode(req.getMsgContent()), "UTF-8");
    }

    public static <T> T getContent(UnionReq req, Class<T> t) throws IOException {
        String decoded = new String((new Base64()).decode(req.getMsgContent()), "UTF-8");
        return JsonUtil.parseJson(decoded, t);
    }
